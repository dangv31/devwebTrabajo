...
public class DataLoader implements CommandLineRunner {
    ...
    private List<ProductData> getProductDataList() {
        return List.of(
                ...
                new ProductData("Reloj Inteligente BerriTime 4G", "Mide pasos, mide el corazón, y hasta mide si lo están mirando mal...", 156000, 185000, "./products/reloj_inteligente_berritime_4g.jpg", "Tecnologia", false, 3, 15),
                new ProductData("Tablet ChiquiBerri 10.1 Wi-Fi", "Con esta tablet berrionda puede trabajar, estudiar, cocinar con recetas de TikTok y hasta ver novelas mientras barre...", 1270000, 1910000, "./products/tablet_chiquiberri_10.1_wi-fi.jpg", "Tecnologia", false, 7, 3),
                ...
                new ProductData("Sanduchera Milagrosa 7 en 1", "¿Aburrido del pan con mantequilla? ¡Con esta sanduchera berrionda, usted hace milagros!...", 188000, 198000, "./products/sanduchera_milagrosa_7_en_1.jpg", "Electrodomesticos", true, 8, 17),
                ...
                new ProductData("Cama Nido con Cajón pa' Guardar Secretos", "Duerma como un rey y guarde sus tesoros como un pirata...", 105007, 194191, "./products/cama_nido_con_cajon_pa_guardar_secretos.jpg", "Muebles", true, 10, 8),
                new ProductData("Mesa de Centro con Altavoz Reguetonero", "Convierta su sala en una discoteca con esta mesa de centro...", 101582, 164011, "./products/mesa_de_centro_con_altavoz_reguetonero.jpg", "Muebles", true, 1, 3),
                new ProductData("Biblioteca con Compartimento Pa' Aguardiente", "Organice sus libros y sus placeres en un solo lugar...", 85167, 166029, "./products/biblioteca_de_madera_con_compartimento_pa_aguardiente.jpg", "Muebles", false, 3, 5),
                new ProductData("Tensiómetro que Dice 'No se Estrese'", "¿La tensión alta lo tiene preocupado? ¡Relájese!...", 130542, 188313, "./products/tensiometro_que_dice_no_se_estrese.jpg", "Salud", false, 5, 9),
                ...
                new ProductData("Pulsera Antiansiedad Reversible", "¿Siente que el mundo se le viene encima? ¡Póngase esta pulsera y verá!...", 125547, 169508, "./products/pulsera_antiansiedad_reversible.jpg", "Salud", false, 10, 5),
                new ProductData("Nebulizador que Cuenta Chismes", "¿Aburrido de las nebulizaciones silenciosas? ¡Este aparato le cambia la vida!...", 140103, 196353, "./products/nebulizador_que_cuenta_chismes.jpg", "Salud", true, 9, 14),
                new ProductData("Camisa Antisudor con Refranes Populares", "Sude la gota gorda, pero con estilo...", 117133, 174639, "./products/camisa_antisudor_con_refranes_populares.jpg", "Ropa", true, 8, 5),
                new ProductData("Pantalón con Bolsillo pa' Todo", "¿Cansado de no tener dónde meter las llaves, el celular, la billetera y el chocorramo?...", 99338, 187247, "./products/pantalon_con_bolsillo_pa_todo.jpg", "Ropa", false, 7, 17),
                new ProductData("Chaqueta Reversible de Lluvia y Rumba", "¡Esté preparado para todo! De un lado, esta chaqueta es impermeable...", 127422, 183184, "./products/chaqueta_reversible_de_lluvia_y_rumba.jpg", "Ropa", false, 10, 20),
                ...
                new ProductData("Trapeador Inteligente con Voz de Abuela", "¿Le da pereza trapear? ¡Con este trapeador, la limpieza se vuelve un parche!...", 155894, 183553, "./products/trapeador_inteligente_con_voz_de_abuela.jpg", "Aseo", true, 4, 16),
                new ProductData("Jabón Líquido Multitareas", "Este jabón es una berraquera, oiga. Sirve pa' lavar la loza, la ropa, el perro y hasta el carro...", 125177, 182461, "./products/jabon_liquido_multitareas.jpg", "Aseo", false, 6, 12),
                new ProductData("Escoba Antipereza", "¡Esta escoba barre hasta la mala suerte!...", 98687, 191528, "./products/escoba_antipereza.jpg", "Aseo", true, 10, 5),
                new ProductData("Ambientador con Olor a Empanada", "¿Quiere que su casa huela a gloria? ¡Este ambientador es la respuesta!...", 137923, 191663, "./products/ambientador_con_olor_a_empanada.jpg", "Aseo", true, 2, 13),
                ...
                new ProductData("Esfero que No se Pierde (Mucho)", "Sabemos que los esferos tienen patas y se van. Pero este, ¡este es diferente!...", 127161, 166249, "./products/esfero_que_no_se_pierde_(mucho).jpg", "Papeleria", true, 5, 20),
                ...
                new ProductData("Muñeca Chismosa con Voz Paisa", "¡La compañera de juegos perfecta! Esta muñeca no solo es bonita, ¡es una chismosa de primera!...", 134733, 179531, "./products/muneca_chismosa_con_voz_paisa.jpg", "Jugueteria", true, 10, 6),
                new ProductData("Carrito Berriondo 4x4 Todo Terreno", "Este carrito es más verraco que un dolor de muela...", 102378, 174424, "./products/carrito_berriondo_4x4_todo_terreno.jpg", "Jugueteria", false, 1, 13),
                new ProductData("Set de Plastilina con Olor a Pandebono", "¡Deje que sus hijos amasen la creatividad! Este set de plastilina no solo es suave y colorida...", 126040, 192749, "./products/set_de_plastilina_con_olor_a_pandebono.jpg", "Jugueteria", false, 4, 18),
                new ProductData("Rompecabezas 3D de la Plaza de Mercado", "¡Arme un pedacito de nuestra tierra! Con este rompecabezas...", 95990, 185493, "./products/rompecabezas_3d_de_la_plaza_de_mercado.jpg", "Jugueteria", true, 7, 11),
                new ProductData("Martillo Cantor de Golpes Precisos", "¿Aburrido de martillar en silencio? ¡Este martillo le pone ritmo a su trabajo!...", 120437, 165281, "./products/martillo_cantor_de_golpes_precisos.jpg", "Herramientas", true, 7, 15),
                new ProductData("Destornillador Multipropósito con Luz", "Este destornillador es la navaja suiza de los paisas...", 149431, 184172, "./products/destornillador_multiproposito_con_luz.jpg", "Herramientas", true, 1, 6),
                new ProductData("Cinta Métrica que Motiva", "¡Mida sus proyectos con optimismo! Esta cinta métrica no solo le da las medidas...", 99144, 177349, "./products/cinta_metrica_que_motiva.jpg", "Herramientas", true, 1, 11),
                new ProductData("Kit Pa’ Arreglar lo que su Ex Dañó", "¡No llore más, póngase a arreglar! Este kit tiene todo lo que necesita...", 144804, 176058, "./products/kit_pa_arreglar_lo_que_su_ex_dano.jpg", "Herramientas", true, 2, 16),
                ...
                new ProductData("Tabla de Picar con Medidor de Anécdotas", "Esta tabla no es solo pa' picar comida, ¡es pa' contar historias!...", 120362, 190136, "./products/tabla_de_picar_con_medidor_de_anecdotas.jpg", "Cocina", true, 5, 13),
                ...
                new ProductData("Lamparita de Noche con Luz de Fe", "Pa' los que le tienen miedo a la oscuridad... o al cucо...", 144165, 170724, "./products/lamparita_de_noche_con_luz_de_fe.jpg", "Iluminacion", false, 1, 17),
                ...
                new ProductData("Correa que Traduce Ladridos", "¿No entiende qué le quiere decir su perro? ¡Esta correa es su traductor personal!...", 150213, 198244, "./products/correa_que_traduce_ladridos.jpg", "Mascotas", true, 9, 1),
                ...
                new ProductData("Set de Juguetes pa’ Peludos Berracos", "¡Entretenga a su mascota con los juguetes más verracos!...", 133438, 162628, "./products/set_de_juguetes_pa_peludos_berracos.jpg", "Mascotas", false, 7, 13)
        );
    }
}
